    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ route('home') }}">
            <img src="{{ asset('logo/logo.webp') }}"
                 alt="{{ config('app.name', 'Homestay Booking') }}"
        ...
        <div class="collapse navbar-collapse" id="siteNavMenu">
            ...
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link fw-medium {{ request()->routeIs('home') ? 'text-success' : '' }}"
                       href="{{ route('home') }}">
                        Home
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link fw-medium {{ request()->routeIs('properties.*') ? 'text-success' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link fw-medium {{ request()->routeIs('locations.*') ? 'text-success' : '' }}"
            ...
            <div class="d-flex align-items-center gap-2 ms-auto">
                @auth('customer')
                    <a href="{{ route('customer.dashboard') }}"
                       class="btn btn-site-outline btn-sm">
                        My Bookings
                    </a>
                ...
                @else
                    <a href="{{ route('customer.login') }}"
                       class="btn btn-site-primary btn-sm"
